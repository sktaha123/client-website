...
export function Services() {
  ...
  return (
    <section id="services" className="relative h-screen md:h-[90vh] pt-30  bg-biz-cream font-dm flex items-center overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 w-full">
        
        <div className="grid lg:grid-cols-12 gap-12 items-stretch min-h-[500px]">
          
          {/* --- LEFT: THE NAVIGATOR (5 COLUMNS) --- */}
          <div className="lg:col-span-5 flex flex-col justify-center">
            <div className="mb-8">
              <span className="text-biz-bronze font-bold tracking-ultra uppercase text-[10px]">Ecosystem</span>
              <h2 className="text-4xl md:text-5xl text-biz-charcoal-ink font-light tracking-tightest mt-2">
                Our <span className="text-biz-bronze italic font-serif">Solutions</span>
              </h2>
            </div>
            ...
            <div className="space-y-1">
              {services.map((service, i) => (
                <button
                  ...
                  className={`group flex items-center gap-4 w-full text-left py-3 px-4 rounded-xl transition-all duration-300 ${
                    active === i ? "bg-biz-bronze-pale/20 translate-x-2" : "opacity-40 hover:opacity-100"
                  }`}
                >
                  ...
                  {active === i && (
                    <motion.div layoutId="dot" className="w-1.5 h-1.5 rounded-full bg-biz-bronze ml-auto" />
                  )}
                </button>
              ))}
            </div>
          ...
          {/* --- RIGHT: THE FOCUS CARD (7 COLUMNS) --- */}
          <div className="lg:col-span-7 relative flex items-center">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className={`w-full p-10 md:p-16 rounded-biz shadow-2xl relative overflow-hidden flex flex-col justify-center min-h-[420px] ${services[active].bg}`}
              >
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-12">
                    ...
                    <span className="text-[10px] font-black tracking-ultra opacity-50 uppercase mt-2">
            ...
            {/* Decorative Grid Behind Card */}
            <div className="absolute inset-0 border-[0.5px] border-biz-bronze/10 -m-4 rounded-biz -z-10" />
          </div>
